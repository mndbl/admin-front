...
import { activePrimaryMenu, defaultPrimaryMenu, activeSecondaryMenu, defaultSecondaryMenu } from "../../assets/styles/tailwindClass";
                        ...
                        <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table className="min-w-full divide-y divide-gray-200">
                                    <caption className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> Relación Ingresos y Egresos</caption>
