                ...
                <form>
                    <div className="grid grid-cols-2 gap-x-2 mt-4 lg:grid-cols-3 border-b-2 pb-2">
                        <div>
                            ...
                            <input id="fecha_compra" type="date" className={styleInput}
                            />
                        </div>
                        <div>
                            <label className="text-gray-700 dark:text-gray-200 capitalize" htmlFor="proveedor">Proveedor</label>
                            <select id="proveedor" className={styleInput}>
                                <option>Seleccione Proveedor</option>
                            </select>
                        </div>
                        <div>
                            <label className="text-gray-700 dark:text-gray-200 capitalize" htmlFor="monto_compra">Monto</label>
                            <input id="monto_compra" type="number" min="0" step="0.01" defaultValue="0.00" className={"text-right " + styleInput}
                            />
                        </div>
                        <div className="">
