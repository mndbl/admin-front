export function TablesLayout({title= 'Por defecto', headers, data}) {
    return (
                                        ...
                                        <div className="flex items-center">
                                            <div className="flex-shrink-0">
                                                <a href="#" className="block relative">
                                                    <img alt="profil" src="https://images.pexels.com/photos/2726111/pexels-photo-2726111.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" className="mx-auto object-cover rounded-full h-10 w-10 " />
                                                </a>
                                            </div>
                                            <div className="ml-3">
